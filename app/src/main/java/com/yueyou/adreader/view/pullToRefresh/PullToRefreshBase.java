...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout {
	...
	private com.yueyou.adreader.view.pullToRefresh.LoadingLayout headerLayout;
	private com.yueyou.adreader.view.pullToRefresh.LoadingLayout footerLayout;
	...
	protected final com.yueyou.adreader.view.pullToRefresh.LoadingLayout getFooterLayout() {
		return footerLayout;
	}

	protected final com.yueyou.adreader.view.pullToRefresh.LoadingLayout getHeaderLayout() {
		return headerLayout;
	}
	...
	/**
	 * Actions a Pull AdEvent
	 * 
	 * @return true if the AdEvent has been handled, false if there has been no
	 *         change
	 */
